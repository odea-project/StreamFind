...
stat$make_model(StatisticSettings_MakeModel_pca_mdatools(ncomp = 3, alpha = 1E-4, gamma = 1E-5))
...
stat2$prepare_classification(StatisticSettings_PrepareClassification_knn(k = 3))
...
stat_ms$make_model(StatisticSettings_MakeModel_pca_mdatools(ncomp = 3, alpha = 1E-4, gamma = 1E-5))
```
...
stat_raman$make_model(StatisticSettings_MakeModel_pca_mdatools(ncomp = 3, alpha = 1E-4, gamma = 1E-5))
```
...
stat3$make_model(StatisticSettings_MakeModel_mcrals_mdatools(ncomp = 3))
summary(stat3$model)
```
