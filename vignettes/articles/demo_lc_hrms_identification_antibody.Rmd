---
title: 'Identification of Intact Monoclonal Antibody Bevacizumab using LC coupled to HRMS'
author:
  name: Ricardo Cunha
  email: cunha@iuta.de
...
vignette: >
  ...
  %\VignetteIndexEntry{'Identification of Intact Monoclonal Antibody Bevacizumab using LC coupled to HRMS'}
...
```{r plot-spectra-maxima}
plot_spectra_peaks(ms$Spectra, colorBy = "analyses+targets")
```
