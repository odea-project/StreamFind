...
raman_workflow_settings <- list(
  Settings_bin_spectra_StreamFind(unitsVal = "rt", unitsNumber = 19),
  # Settings_normalize_spectra_minmax(),
  ...
  Settings_delete_spectra_section_StreamFind(list("shift" = c(2300, 2600))),
  Settings_correct_spectra_baseline_airpls(lambda = 60, differences = 1),
  Settings_correct_spectra_baseline_baseline(method = "als", args = list(lambda = 3, p = 0.015, maxit = 10)),
