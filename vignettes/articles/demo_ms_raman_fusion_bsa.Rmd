...
ms <- MassSpecEngine$new(files = ms_files[1:12], headers = list(name = "BSA Quality Evaluation Project"))
...
ms$bin_spectra(Settings_bin_spectra_StreamFind(bins = list("rt" = 5, "mass" = 1))
