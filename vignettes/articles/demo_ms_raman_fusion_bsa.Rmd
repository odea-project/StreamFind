...
ms$smooth_chromatograms(MassSpecSettings_SmoothChromatograms_movingaverage(windowSize = 5))
```
...
stat$make_model(StatisticSettings_MakeModel_pca_mdatools(ncomp = 2, alpha = 0.05, gamma = 0.02))
...
stat$make_model(StatisticSettings_MakeModel_mcrpure_mdatools(ncomp = 2, offset = 0.05))
summary(stat$model)
```
