---
title: "streamFind: overview of R package for mass spectrometry"
output:
...
The streamFind R package includes example data files via the [streamFindData](https://github.com/ricardobachertdacunha/streamFindData)  R package.
