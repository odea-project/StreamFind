...
files <- StreamFindData::get_all_file_paths()
...
df_files_desc <- StreamFindData::get_all_file_descriptions()
...
slfgms1 <- Settings_load_features_ms1_StreamFind(
  rtWindow = c(-2, 2),
  mzWindow = c(-1, 6),
  mzClust = 0.003,
  presence = 0.9,
...
slfgms2 <- Settings_load_features_ms2_StreamFind(
  isolationWindow = 1.3,
  mzClust = 0.003,
  presence = 0.9,
  minIntensity = 0,
