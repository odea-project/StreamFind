...
settingsSettings_load_features_ms1_streamFind <- ProcessingSettings(
...
ms$add_settings(settings = settingsSettings_load_features_ms1_streamFind)

# Settings for loading features MS2 spectra
settingsSettings_load_features_ms2_streamFind <- ProcessingSettings(
...
ms$add_settings(settings = settingsSettings_load_features_ms2_streamFind)
...
msTargets$load_features_ms2(settings = settingsSettings_load_features_ms2_streamFind)
...
settingsSettings_load_groups_ms1_streamFind <- ProcessingSettings(
...
msTargets$add_settings(settings = settingsSettings_load_groups_ms1_streamFind)

# Settings for loading groups MS2 spectra
settingsSettings_load_groups_ms2_streamFind <- ProcessingSettings(
...
msTargets$add_settings(settings = settingsSettings_load_groups_ms2_streamFind)
