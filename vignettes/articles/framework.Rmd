...
A `ProcessingSettings` object must always have the engine type to be aplied, the call name of the processing method, the name of the algorithm to be applied, the origin software, the main developer name and contact as well as a link to further information and the DOI, when available.
