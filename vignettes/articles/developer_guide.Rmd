...
R6 class is used for management of the `Metadata`, `MassSpecAnalyses`, `MassSpecResults`, `AuditTrail` and `Config` class objects.

```{r create-empty-ms, results='markup'}
# Create an Engine child class for MS data.
