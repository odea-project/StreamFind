...
#'
#' @return A RamanSettings_MergeSpectraTimeSeries_StreamFind object.
#'
#' @export
#'
RamanSettings_MergeSpectraTimeSeries_StreamFind <- S7::new_class("RamanSettings_MergeSpectraTimeSeries_StreamFind",
...
#' @export
#' @noRd
S7::method(run, RamanSettings_MergeSpectraTimeSeries_StreamFind) <- function(x, engine = NULL) {
