...
#' @describeIn RamanMethod_DeleteScansSection_native Validate the RamanMethod_DeleteScansSection_native object, returning NULL if valid.
#' @param x A RamanMethod_DeleteScansSection_native object.
#' @export
#'
