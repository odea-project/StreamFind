#' **RamanSettings_CalculateSpectraSimilary_hqi**
#'
...
#'
#' @return A RamanSettings_CalculateSpectraSimilary_hqi object.
#'
#' @export
#'
RamanSettings_CalculateSpectraSimilary_hqi <- S7::new_class(
  "RamanSettings_CalculateSpectraSimilary_hqi",
...
#' @export
#' @noRd
S7::method(run, RamanSettings_CalculateSpectraSimilary_hqi) <- function(x, engine = NULL) {
