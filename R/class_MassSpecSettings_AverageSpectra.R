...
#' @export
#'
MassSpecSettings_AverageSpectra_StreamFind <- S7::new_class(
  name = "MassSpecSettings_AverageSpectra_StreamFind",
      ...
      if (engine$chromatograms$has_peaks) {
        if (!"id" %in% colnames(spectra)) {
          warning(
            ...
            "using MassSpecSettings_FilterSpectra_StreamFind! Not done."
          )
          return(FALSE)
        }
