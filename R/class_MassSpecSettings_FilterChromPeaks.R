...
#'
#' @return A MassSpecSettings_FilterChromPeaks_native object.
#'
#' @export
#'
MassSpecSettings_FilterChromPeaks_native <- S7::new_class(
  "MassSpecSettings_FilterChromPeaks_native",
...
#' @export
#' @noRd
S7::method(run, MassSpecSettings_FilterChromPeaks_native) <- function(x, engine = NULL) {
