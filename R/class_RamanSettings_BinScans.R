...
#' 
#' @returns A RamanSettings_BinScans_native object.
#'
#' @export 
#'
RamanSettings_BinScans_native <- S7::new_class(
  name = "RamanSettings_BinScans_native",
...
#' @export
#' @noRd
S7::method(run, RamanSettings_BinScans_native) <- function(x, engine = NULL) {
