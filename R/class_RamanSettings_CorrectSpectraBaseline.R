...
#' for more details.
#'
#' @return A RamanSettings_CorrectSpectraBaseline_baseline object.
#'
#' @export
#'
RamanSettings_CorrectSpectraBaseline_baseline <- S7::new_class("RamanSettings_CorrectSpectraBaseline_baseline",
...
#' @export
#' @noRd
S7::method(run, RamanSettings_CorrectSpectraBaseline_baseline) <- function(x, engine = NULL) {
