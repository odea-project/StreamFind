...
.s3_deconvolute_spectra_charges.Settings_deconvolute_spectra_charges_StreamFind <- function(settings, self, private) {
  ...
  spec_list <- lapply(spec_list, function(x, roundVal, relLowCut, absLowCut) {
    ...
    if (nrow(x) > 0) {
      ...
      if (TRUE) plot_charges_annotated(x, res)
...
#' @title .s3_deconvolute_spectra_charges.Settings_deconvolute_spectra_charges_StreamFind2
#'
#' @description Deconvolutes spectra charges from multi-charged compounds.
#'
#' @noRd
#'
.s3_deconvolute_spectra_charges.Settings_deconvolute_spectra_charges_StreamFind2 <- function(settings, self, private) {
