...
#'
#' @return A MassSpecSettings_SmoothSpectra_movingaverage object.
#'
#' @export
#'
...
#' @export
#' @noRd
S7::method(run, MassSpecSettings_SmoothSpectra_movingaverage) <- function(x, engine = NULL) {
...
#' @export
#' @noRd
S7::method(run, MassSpecSettings_SmoothSpectra_savgol) <- function(x, engine = NULL) {
