...
#'
#' @description Settings for annotation of isotopic and adduct features. The method uses the
...
#' @export
#'
MassSpecSettings_AnnotateFeatures_StreamFind <- S7::new_class(
  name = "MassSpecSettings_AnnotateFeatures_StreamFind",
