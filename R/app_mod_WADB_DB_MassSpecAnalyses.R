#' @noRd
.mod_WADB_Analyses_UI.DB_MassSpecAnalyses <- function(x, id, ns) {
  ns2 <- shiny::NS(id)
  shinydashboard::box(
    title = NULL,
    width = 12,
...
#' @noRd
.mod_WADB_Analyses_Server.DB_MassSpecAnalyses <- function(
    x,
    id,
    ns,
  ...
  shiny::moduleServer(id, function(input, output, session) {
    ...
    data_type_details <- DataTypeObjects("DB_MassSpec")
