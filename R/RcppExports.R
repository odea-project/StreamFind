...
rcpp_nts_find_features <- function(info, spectra_headers, rtWindowsMin, rtWindowsMax, resolution_profile, noiseBins = 70L, noiseThreshold = 15.0, noiseQuantile = 0.01, minSNR = 3.0, minTraces = 3L, baselineWindow = 200.0, maxWidth = 100.0, minGaussFit = 0.6) {
    .Call(`_StreamFind_rcpp_nts_find_features`, info, spectra_headers, rtWindowsMin, rtWindowsMax, resolution_profile, noiseBins, noiseThreshold, noiseQuantile, minSNR, minTraces, baselineWindow, maxWidth, minGaussFit)
}
