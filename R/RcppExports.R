...
rcpp_nts_find_features2 <- function(info, spectra_headers, rtWindowsMin, rtWindowsMax, resolution_profile, noiseThreshold = 15.0, minSNR = 3.0, minTraces = 3L, baselineWindow = 200.0, maxWidth = 100.0, base_quantile = 0.10, debug_mz = 0.0) {
    .Call(`_StreamFind_rcpp_nts_find_features2`, info, spectra_headers, rtWindowsMin, rtWindowsMax, resolution_profile, noiseThreshold, minSNR, minTraces, baselineWindow, maxWidth, base_quantile, debug_mz)
}
