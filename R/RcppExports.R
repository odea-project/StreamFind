...
rcpp_nts_find_features2 <- function(info, spectra_headers, rtWindowsMin, rtWindowsMax, ppmThreshold = 15.0, noiseThreshold = 15.0, minSNR = 3.0, minTraces = 3L, baselineWindow = 200.0, maxWidth = 100.0, baseQuantile = 0.10, debugMZ = 0.0, debugSpecIdx = -1L) {
    .Call(`_StreamFind_rcpp_nts_find_features2`, info, spectra_headers, rtWindowsMin, rtWindowsMax, ppmThreshold, noiseThreshold, minSNR, minTraces, baselineWindow, maxWidth, baseQuantile, debugMZ, debugSpecIdx)
}
