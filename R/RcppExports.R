...
rcpp_ms_annotation_isotopes <- function(features, maxIsotopes = 6L, maxCharge = 3L, rtWindowAlignment = 0.5) {
    .Call(`_streamFind_rcpp_ms_annotation_isotopes`, features, maxIsotopes, maxCharge, rtWindowAlignment)
}
