...
parse_msAnalysis_from_mzxml <- function(file_path) {
    .Call(`_streamFind_parse_msAnalysis_from_mzxml`, file_path)
}

rcpp_parse_mzxml_files <- function(file_path) {
    .Call(`_streamFind_rcpp_parse_mzxml_files`, file_path)
}
