...
#' @export
#'
MassSpecResults_NonTargetAnalysis2 <- function(
  ...
  x <- structure(
    ...
    class = c("MassSpecResults_NonTargetAnalysis2", "Results")
  )
  if (is.null(validate_object(x))) {
    return(x)
  } else {
    stop("Invalid MassSpecResults_NonTargetAnalysis2 object.")
  }
}

#' @describeIn MassSpecResults_NonTargetAnalysis2 Validates the MassSpecResults_NonTargetAnalysis2 object, returning NULL if valid.
#' @template arg-nts-x
#' @export
#'
...
# MARK: show
#' @describeIn MassSpecResults_NonTargetAnalysis2 Prints a summary of the MassSpecResults_NonTargetAnalysis2 object.
#' @template arg-nts-x
#' @export
#'
show.MassSpecResults_NonTargetAnalysis2 <- function(x) {
  cat("\n")
  cat(is(x))
  cat("\n")
  if (length(x$features) == 0) {
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Converts a list object to a `MassSpecResults_NonTargetAnalysis2` object if it is compatible.
#' @template arg-value
#' @export
#'
as.MassSpecResults_NonTargetAnalysis2 <- function(value) {
  if (is(value, "MassSpecResults_NonTargetAnalysis2")) {
  ...
  if (is.list(value)) {
    if (all(c("info", "headers", "features") %in% names(value))) {
      ...
      nts <- MassSpecResults_NonTargetAnalysis2(
        info = value$info,
      ...
      stop("List does not contain required components for MassSpecResults_NonTargetAnalysis2.")
    }
  } else {
    stop("Value is not a list or MassSpecResults_NonTargetAnalysis2 object.")
  }
}
...
#' @export
#' @noRd
names.MassSpecResults_NonTargetAnalysis2 <- function(x) {
  names(x$features)
}

# MARK: `[`
#' @describeIn MassSpecResults_NonTargetAnalysis2 Subsets the MassSpecResults_NonTargetAnalysis2 object by analyses (with `i`) or feature groups (`j`).
#' @template arg-nts-x
#' @template arg-i
#' @template arg-j
#' @export
#'
`[.MassSpecResults_NonTargetAnalysis2` <- function(x, i, j) {
  if (length(x$features) == 0) {
...
#' @export
#'
get_features_count.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    filtered = FALSE) {
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots the number of features for each analysis as a bar plot.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-filtered
#' @template arg-yLab
...
#' @export
#'
plot_features_count.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    filtered = FALSE,
    yLab = NULL,
...
# MARK: get_features
#' @describeIn MassSpecResults_NonTargetAnalysis2 Returns a data table with the features for the specified analyses and targets.
#' @template arg-nts-x
#' @template arg-analyses
...
#' @export
#'
get_features.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
# MARK: map_features
#' @describeIn MassSpecResults_NonTargetAnalysis2 Maps features from the MassSpecResults_NonTargetAnalysis2 object.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
map_features.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Maps features intensity from the MassSpecResults_NonTargetAnalysis2 object.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
map_features_intensity.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Returns a data table with the extracted ion chromatograms (EIC) for features in the specified analyses and targets.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
get_features_eic.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
# MARK: plot_features
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots features from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
plot_features.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Returns a data table with MS1 features for the specified analyses and targets.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
get_features_ms1.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots MS1 features from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
plot_features_ms1.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Returns a data table with MS2 features for the specified analyses and targets.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
get_features_ms2.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots MS2 features from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
plot_features_ms2.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
# MARK: get_groups
#' @describeIn MassSpecResults_NonTargetAnalysis2 Returns a data table with group information for the specified analyses and targets.
#' @template arg-nts-x
...
#' @export
#'
get_groups.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    groups = NULL,
    mass = NULL,
    mz = NULL,
...
# MARK: plot_groups
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots groups from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-groups
#' @template arg-ms-mass
...
#' @export
#'
plot_groups.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    groups = NULL,
    mass = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots an overview of groups from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-groups
#' @template arg-ms-mass
...
#' @export
#'
plot_groups_overview.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    groups = NULL,
    mass = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots the profile of groups from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-groups
#' @template arg-ms-mass
...
#' @export
#'
plot_groups_profile.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    groups = NULL,
    mass = NULL,
...
# MARK: get_groups_ms1
#' @describeIn MassSpecResults_NonTargetAnalysis2 Extracts MS1 data for groups from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-ms-groups
#' @template arg-ms-mass
#' @template arg-ms-mz
...
#' @export
#'
get_groups_ms1.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    groups = NULL,
    mass = NULL,
    mz = NULL,
...
# MARK: get_groups_ms2
#' @describeIn MassSpecResults_NonTargetAnalysis2 Extracts MS2 data for groups from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-ms-groups
#' @template arg-ms-mass
#' @template arg-ms-mz
...
#' @export
#'
get_groups_ms2.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    groups = NULL,
    mass = NULL,
    mz = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots MS1 traces for groups from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-ms-groups
#' @template arg-ms-mass
#' @template arg-ms-mz
...
#' @export
#'
plot_groups_ms1.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    groups = NULL,
    mass = NULL,
    mz = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots MS2 traces for groups from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-ms-groups
#' @template arg-ms-mass
#' @template arg-ms-mz
...
#' @export
#'
plot_groups_ms2.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    groups = NULL,
    mass = NULL,
    mz = NULL,
...
# MARK: get_components
#' @describeIn MassSpecResults_NonTargetAnalysis2 Extracts components based on annotation from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
get_components.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
# MARK: map_components
#' @describeIn MassSpecResults_NonTargetAnalysis2 Maps components based on annotation from the MassSpecResults_NonTargetAnalysis2 object according to the specified parameters.
#' @template arg-nts-x
#' @template arg-analyses
#' @template arg-ms-features
#' @template arg-ms-mass
...
#' @export
#'
map_components.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    analyses = NULL,
    features = NULL,
    mass = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Plots the fold-change analysis between the `replicatesIn` and `replicatesOut`. This method is adapted from the work of \href{https://pubs.acs.org/doi/10.1021/acs.analchem.7b03037}{Bader et al. (2017)}.
#'
#' @param replicatesIn Character vector with the names of the replicates to be considered as
#' the denominator.
#' @param replicatesOut Character vector with the names of the replicates to be considered as
...
#' @export
#'
plot_fold_change.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    replicatesIn = NULL,
    replicatesOut = NULL,
    groups = NULL,
...
#' @describeIn MassSpecResults_NonTargetAnalysis2  Creates an S4 class `features` or `featureGroups`from the \pkg{patRoon} package.
#' @template arg-nts-x
#' @template arg-ms-filtered
#' @param featureGroups Logical of length one. When `TRUE` the `featureGroups` class is returned.
#' @export
#'
get_patRoon_features.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    filtered = FALSE,
    featureGroups = TRUE) {
  if (length(x$features) == 0) {
...
#' @describeIn MassSpecResults_NonTargetAnalysis2 Creates S4 class `MSPeakLists`. Note that feature groups are required. The MS and MSMS spectra of each feature are then average by \pkg{patRoon} to produce the feature group spectra.
#' @template arg-nts-x
#' @template arg-ms-mzClust
#' @template arg-ms-minIntensity
#' @template arg-ms-presence
...
#' @export
#'
get_patRoon_MSPeakLists.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    mzClust = 0.005,
    minIntensity = 0,
    presence = 0.7,
...
#' @export
#'
report.MassSpecResults_NonTargetAnalysis2 <- function(
    x,
    filtered = FALSE,
    mzClust = 0.005,
    minIntensity = 10,
...
.add_features_column <- function(
  ...
  if (!is(MassSpecResults_NonTargetAnalysis2, "StreamFind::MassSpecResults_NonTargetAnalysis2")) {
    ...
    return(MassSpecResults_NonTargetAnalysis2)
  }
  if (MassSpecResults_NonTargetAnalysis2@has_features) {
    feature_list <- MassSpecResults_NonTargetAnalysis2@feature_list
    feature_list <- Map(
      function(x, y) {
        if (nrow(x) == length(y)) {
          x[[name]] <- y
    ...
    MassSpecResults_NonTargetAnalysis2$feature_list <- feature_list
  } else {
    warning("No features found! Not done.")
  }
  MassSpecResults_NonTargetAnalysis2
}
