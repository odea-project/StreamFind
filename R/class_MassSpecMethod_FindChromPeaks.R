...
#' @export
#' @noRd
S7::method(run, MassSpecMethod_FindChromPeaks_LocalMaxima) <- function(x, engine = NULL) {
...
#' @export
#' @noRd
S7::method(run, MassSpecMethod_FindChromPeaks_pracma) <- function(x, engine = NULL) {
