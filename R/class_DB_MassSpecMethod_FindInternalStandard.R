...
#' @export
#'
DB_MassSpecMethod_FindInternalStandard_native <- function(
  suspects = NULL,
  ppm = 5,
  sec = 10,
  ppmMS2 = 10,
  ...
  if (is.null(validate_object(x))) {
    ...
    stop("Invalid parameters for DB_MassSpecMethod_FindInternalStandard_native.")
  }
}

#' @export
#' @noRd
validate_object.DB_MassSpecMethod_FindInternalStandard_native <- function(x) {
...
#' @export
#' @noRd
run.DB_MassSpecMethod_FindInternalStandard_native <- function(x, engine = NULL) {
