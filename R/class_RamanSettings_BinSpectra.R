...
#' @export 
#'
RamanSettings_BinSpectra_StreamFind <- S7::new_class("RamanSettings_BinSpectra_StreamFind",
...
#' @export
#' @noRd
S7::method(run, RamanSettings_BinSpectra_StreamFind) <- function(x, engine = NULL) {
