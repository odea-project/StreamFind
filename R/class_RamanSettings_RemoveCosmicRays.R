#' **RamanSettings_RemoveCosmicRays_native**
#'
#' @description Removes cosmic rays from Raman spectra.
#'
#' @return A RamanSettings_RemoveCosmicRays_native object.
#'
#' @export
#'
RamanSettings_RemoveCosmicRays_native <- S7::new_class(
  "RamanSettings_RemoveCosmicRays_native",
...
#' @export
#' @noRd
S7::method(run, RamanSettings_RemoveCosmicRays_native) <- function(x, engine = NULL) {
