...
#'
#' @return A RamanSettings_SmoothSpectra_movingaverage object.
#'
#' @export
#'
RamanSettings_SmoothSpectra_movingaverage <- S7::new_class("RamanSettings_SmoothSpectra_movingaverage",
...
#' @export
#' @noRd
S7::method(run, RamanSettings_SmoothSpectra_movingaverage) <- function(x, engine = NULL) {
...
#'
#' @return A RamanSettings_SmoothSpectra_savgol object.
#'
#' @export
#'
RamanSettings_SmoothSpectra_savgol <- S7::new_class("RamanSettings_SmoothSpectra_savgol",
  parent = ProcessingSettings,
  package = "StreamFind",
...
#' @export
#' @noRd
S7::method(run, RamanSettings_SmoothSpectra_savgol) <- function(x, engine = NULL) {
