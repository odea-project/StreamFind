#' **RamanSettings_SubtractScansSection_native**
#'
...
#'
#' @return A RamanSettings_SubtractScansSection_native object.
#'
#' @export
#'
RamanSettings_SubtractScansSection_native <- S7::new_class(
  name = "RamanSettings_SubtractScansSection_native",
...
#' @export
#' @noRd
S7::method(run, RamanSettings_SubtractScansSection_native) <- function(x, engine = NULL) {
