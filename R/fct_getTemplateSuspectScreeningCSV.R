...
getTemplateSuspectScreeningCSV <- function(file) {
  ...
  tpl <- data.table::rbindlist(list(
    ...
    data.table::data.table(
      ...
      xLogP = -1.394,
      polarity = "positive",
      ms2 = "43.01817 198; 67.02847 149; 77.0392 161; 79.0528 198; 80.04926 240; 92.04987 465; 93.03298 392; 93.05672 188; 94.03891 196; 94.06343 147; 96.05484 731; 106.06538 153; 108.04403 1185; 118.06546 260; 134.06009 748; 136.07448 809; 156.00804 178; 198.02271 842; 227.09206 362; 293.06976 2114"
    ),
    data.table::data.table(
      name = "Metoprolol",
      formula = "C15H25NO3",
