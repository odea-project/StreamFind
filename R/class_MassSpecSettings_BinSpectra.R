...
#' 
#' @param binNames Character with the variable names for building the bins. Possible values are *rt*, *mz*, *mass*, 
#' *mobility*. Note that the `binNames` must be in the spectra column names.
