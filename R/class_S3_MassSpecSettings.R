...
#' @title MassSpecSettings_FindFeatures_qPeaks
#'
#' @description Not yet implemented.
#'
#' @export
#'
MassSpecSettings_FindFeatures_qPeaks <- function() {
...
#' @noRd
#'
validate.MassSpecSettings_FindFeatures_qPeaks <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "FindFeatures"),
...
#' @title MassSpecSettings_FindFeatures_xcms3_centwave
#'
...
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_FindFeatures_xcms3_centwave.
#'
#' @references
...
#' @export
#'
MassSpecSettings_FindFeatures_xcms3_centwave <- function(ppm = 12,
                                                         peakwidth = c(5, 60),
                                                         snthresh = 15,
                                                         prefilter = c(5, 1500),
                                                         mzCenterFun = "wMean",
...
#' @noRd
#'
validate.MassSpecSettings_FindFeatures_xcms3_centwave <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "FindFeatures"),
...
#' @title MassSpecSettings_FindFeatures_xcms3_matchedfilter
#'
#' @description Settings for finding features (i.e., chromatographic peaks) in mzML/mzXML files using the package
#' \href{https://bioconductor.org/packages/release/bioc/html/xcms.html}{xcms} (version 3) with the algorithm
...
#' @details See the \link[patRoon]{findFeaturesXCMS3} function from the \pkg{patRoon} package for more information and requirements.
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_FindFeatures_xcms3_matchedfilter.
#'
#' @references
#' \insertRef{patroon01}{StreamFind}
#'
...
#' @export
#'
MassSpecSettings_FindFeatures_xcms3_matchedfilter <- function(binSize = 0.5,
                                                              impute = "none",
                                                              baseValue = 0,
                                                              distance = 0,
                                                              fwhm = 30,
...
#' @noRd
#'
validate.MassSpecSettings_FindFeatures_xcms3_matchedfilter <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "FindFeatures"),
...
#' @title MassSpecSettings_FindFeatures_openms
#'
...
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_FindFeatures_openms.
#'
#' @references
#' \insertRef{patroon01}{StreamFind}
#'
...
#' @export
#'
MassSpecSettings_FindFeatures_openms <- function(noiseThrInt = 1000,
                                                 chromSNR = 3,
                                                 chromFWHM = 7,
                                                 mzPPM = 15,
                                                 reEstimateMTSD = TRUE,
...
#' @noRd
#'
validate.MassSpecSettings_FindFeatures_openms <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "FindFeatures"),
...
#' @title MassSpecSettings_FindFeatures_kpic2
#'
#' @description Settings for finding features (i.e., chromatographic peaks) in mzML/mzXML files using the package 
...
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_FindFeatures_kpic2.
#'
#' @references
#' \insertRef{patroon01}{StreamFind}
#'
...
#' @export
#'
MassSpecSettings_FindFeatures_kpic2 <- function(level = 500,
                                                mztol = 0.01,
                                                gap = 2,
                                                width = 5,
                                                min_snr = 4,
...
#' @noRd
#'
validate.MassSpecSettings_FindFeatures_kpic2 <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "FindFeatures"),
...
#' @title MassSpecSettings_GroupFeatures_xcms3_peakdensity
#'
...
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_GroupFeatures_xcms3_peakdensity.
#'
#' @references
#' \insertRef{patroon01}{StreamFind}
#'
...
#' @export
#'
MassSpecSettings_GroupFeatures_xcms3_peakdensity <- function(bw = 5,
                                                             minFraction = 1,
                                                             minSamples = 1,
                                                             binSize = 0.008,
                                                             maxFeatures = 100) {
...
#' @noRd
#'
validate.MassSpecSettings_GroupFeatures_xcms3_peakdensity <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "GroupFeatures"),
...
#' @title MassSpecSettings_GroupFeatures_xcms3_peakdensity_peakgroups
#'
...
#' @details See the \link[patRoon]{groupFeaturesXCMS3} function from the \pkg{patRoon} package for more information and requirements.
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_GroupFeatures_xcms3_peakdensity_peakgroups.
#'
#' @references
#' \insertRef{patroon01}{StreamFind}
#'
...
#' @export
#'
MassSpecSettings_GroupFeatures_xcms3_peakdensity_peakgroups <- function(bw = 5,
                                                                        minFraction = 1,
                                                                        minSamples = 1,
                                                                        binSize = 0.008,
                                                                        pre_bw = 5,
...
#' @noRd
#'
validate.MassSpecSettings_GroupFeatures_xcms3_peakdensity_peakgroups <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "GroupFeatures"),
...
#' @title MassSpecSettings_GroupFeatures_openms
#'
...
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_GroupFeatures_openms.
#'
#' @references
#' \insertRef{patroon01}{StreamFind}
#'
...
#' @export
#'
MassSpecSettings_GroupFeatures_openms <- function(rtalign = FALSE,
                                                  QT = FALSE,
                                                  maxAlignRT = 5,
                                                  maxAlignMZ = 0.008,
                                                  maxGroupRT = 5,
...
#' @noRd
#'
validate.MassSpecSettings_GroupFeatures_openms <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "GroupFeatures"),
    checkmate::test_choice(x$algorithm, "openms"),
...
#' @title MassSpecSettings_FillFeatures_StreamFind
#'
...
#' @export
#'
MassSpecSettings_FillFeatures_StreamFind <- function(rtExpand = 1, mzExpand = 0.0005) {
...
#' @noRd
#'
validate.MassSpecSettings_FillFeatures_StreamFind <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "FillFeatures"),
    checkmate::test_choice(x$algorithm, "StreamFind"),
...
#' @title MassSpecSettings_FilterFeatures_StreamFind
#'
...
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_FilterFeatures_StreamFind.
#'
#' @export
#'
MassSpecSettings_FilterFeatures_StreamFind <- function(minSnRatio = 3, excludeIsotopes = TRUE) {
...
#' @noRd
#'
validate.MassSpecSettings_FilterFeatures_StreamFind <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "FilterFeatures"),
    checkmate::test_choice(x$algorithm, "StreamFind"),
...
#' @title MassSpecSettings_FilterFeatures_patRoon
#'
...
#' @export
#'
MassSpecSettings_FilterFeatures_patRoon <- function(absMinIntensity = NULL,
...
#' @noRd
#'
validate.MassSpecSettings_FilterFeatures_patRoon <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "FilterFeatures"),
    checkmate::test_choice(x$algorithm, "patRoon"),
...
#' @title MassSpecSettings_AnnotateFeatures_StreamFind
#'
...
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_AnnotateFeatures_StreamFind.
#'
#' @export
#'
MassSpecSettings_AnnotateFeatures_StreamFind <- function(maxIsotopes = 5,
...
#' @noRd
#'
validate.MassSpecSettings_AnnotateFeatures_StreamFind <- function(x) {
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "AnnotateFeatures"),
    checkmate::test_choice(x$algorithm, "StreamFind"),
...
#' @title MassSpecSettings_FindInternalStandards_StreamFind
#'
...
#' @template arg-ms-sec
#'
#' @return A ProcessingSettings S3 class object with subclass MassSpecSettings_FindInternalStandards_StreamFind.
#'
#' @export
#'
MassSpecSettings_FindInternalStandards_StreamFind <- function(database = NULL, ppm = 5, sec = 10) {
...
#' @noRd
#'
validate.MassSpecSettings_FindInternalStandards_StreamFind <- function(x) {
  
  x$parameters$database <- data.table::as.data.table(x$parameters$database)
  
  all(
    checkmate::test_choice(x$engine, "MassSpec"),
    checkmate::test_choice(x$call, "FindInternalStandards"),
    checkmate::test_choice(x$algorithm, "StreamFind"),
    checkmate::test_number(x$parameters$ppm),
    checkmate::test_number(x$parameters$sec)
  ) && if (is.data.frame(x$parameters$database)) {
