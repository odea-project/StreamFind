...
#' @export
#' @noRd
S7::method(run, RamanMethod_CorrectSpectraBaseline_baseline_als) <- function(x, engine = NULL) {
...
#' @export
#' @noRd
S7::method(run, RamanMethod_CorrectSpectraBaseline_airpls) <- function(x, engine = NULL) {
