...
// rcpp_features_df_list_to_df
Rcpp::DataFrame rcpp_features_df_list_to_df(Rcpp::List features);
RcppExport SEXP _streamFind_rcpp_features_df_list_to_df(SEXP featuresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type features(featuresSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_features_df_list_to_df(features));
...
static const R_CallMethodDef CallEntries[] = {
    {"_streamFind_rcpp_features_df_list_to_df", (DL_FUNC) &_streamFind_rcpp_features_df_list_to_df, 1},
