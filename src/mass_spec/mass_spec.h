...
// Re-export all processing functions for backward compatibility
using processing::whittaker_smooth;
using processing::airpls_baseline;
using processing::als_baseline;
using processing::moving_average;
using processing::savitzky_golay;
using processing::integrate_peak;
using processing::find_peaks_local_maxima;
using processing::find_peaks_pracma;
using processing::ols_fit;
using processing::ols_predict;
