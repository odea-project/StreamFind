...
// MARK: rcpp_streamcraft_decode_string
// [[Rcpp::export]]
std::vector<float> rcpp_streamcraft_decode_string(std::string base64_encoded) {
  ...
  try {
    ...
    Rcpp::warning("Failed to decode string: " + std::string(e.what()));
    return std::vector<float>();
  }
};
...
// MARK: rcpp_streamcraft_parse_ms_spectra
// [[Rcpp::export]]
...
// MARK: rcpp_streamcraft_parse_ms_chromatograms
// [[Rcpp::export]]
