...
#' data.frame with columns named `mz` and `rt` and/or `drift`. Then, the 
...
#' targets. In this case, the column names must be `mzmin`, `mzmax`, `rtmin`, 
#' `rtmax`, `driftmin` and `driftmax`. Note that when mass/time ranges
