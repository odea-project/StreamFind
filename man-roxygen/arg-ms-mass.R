...
#' can be given as one data.table or data.frame with columns named `mass` and 
#' `rt` and/or `drift`. Then, the deviations given in the \code{ppm}, \code{sec}
...
#' must be `min`, `max`, `rtmin`, `rtmax`, `driftmin` and `driftmax`. Note that 
