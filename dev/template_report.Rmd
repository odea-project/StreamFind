...
output:
  bookdown::html_document2:
    ...
    code_folding: hide
    includes:
      in_header: !expr noquote(paste0(system.file(package = "streamFindData", dir = "extdata"), "\\logo_iuta_template_report.html"))
editor_options: 
...
The report was produced on `r Sys.time()`. The data and report are stored in ``r path`` of the workstation *`r Sys.info()["nodename"]`* under the user *`r Sys.info()["user"]`*.  
