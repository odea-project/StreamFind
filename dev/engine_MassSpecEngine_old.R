...
#' under Windows OS.
#' 
#' @details The `MassSpecEngine` is using several \href{https://github.com/rickhelmus/patRoon}{patRoon} assets for assembly of Non-Target Analysis (NTA) data processing workflows.
#' 
