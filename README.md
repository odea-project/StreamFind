...
The R package `streamFind` (this repository) is the back-end platform
for the streamFind project entitled “Flexible data analysis and workflow
designer to identify chemicals in the water cycle”. The streamFind
project is funded by the [Bundesministerium für Bildung und Forschung
...
studies. The `streamFind` R aims to stimulate the use of advanced data
...
firstly ensure that the dependencies are currently installed. Several
existing R packages and external software are used in `streamFind` for
various processing steps. A major dependency of `streamFind` is the
[patRoon](https://github.com/rickhelmus/patRoon) R package. The
`patRoon` R package combines several tools for basic and advanced data
